...
const Register = () => {
    ...
    return (
        <div className=" relative md:w-[28rem]  mx-auto p-2  bg-gray-800 rounded-lg shadow-md mt-1 h-full  ">
            <h1 className="text-3xl text-center text-pink-600 font-bold mb-6 mt-10"> Register Now  </h1>
            <form onSubmit={handleLogin}>
                ...
                <div className="mb-4 ">
                    <label className="block text-white  text-md font-semibold mb-2 " htmlFor=""> Img URL </label>
                ...
                <div className=" w-32 py-1.5 rounded-md mt-6  justify-center mx-auto text-center bg-pink-600 hover:bg-pink-800  ">
                    <button type="submit" className=" w-28 text-white font-bold  "> Register Now  </button>
                </div>
