...
const Contact = () => {
    ...
    return (
        <section id="contact" className=" py-10 px-3 text-white bg-slate-900 ">
            <div className=" text-center mt-8 ">
                <h3 className="text-2xl font-semibold"> Contact <span className=" text-pink-600">Me</span>  </h3>
                ...
                <div className=" mt-16 flex md:flex-row flex-col gap-6 mx-w-5xl bg-slate-900 md:p-6 p-2  rounded-lg mx-auto  ">
                    <form className=" flex flex-col flex-1 gap-5 ">
                        ...
                        <input type="email" name="" required id="" placeholder="Email Address" />
                    ...
                    <div className=" flex flex-col gap-8 ">
                        <div className="flex gap-4 w-fit items-center ">
                            <div className='min-w-[3rem] min-h-[3rem] flex items-center justify-center text-white bg-pink-600 rounded-full  '>
